...
const EXPLANATIONS = {
  ...
  stage2count: {
    ...
    text: "סופר כמה מתוך 19 המניות שאנחנו עוקבים עומדות ב-3 תנאים:\n\n1. מחיר מעל ממוצע 150 יום שמעל ממוצע 200 יום (מגמה עולה)\n2. ציון RS (חוזק יחסי) מעל 70\n3. פחות מ-25% מתחת לשיא השנתי\n\nאם מעט מניות עוברות — השוק חלש. הרבה מניות = שוק בריא.",
  },
  strongestTicker: {
    title: "Strongest Ticker - המניה הכי חזקה",
    text: "המניה עם ציון RS (חוזק יחסי) הגבוה ביותר מכל 19 המניות שאנחנו עוקבים. RS גבוה אומר שהמניה מכה את ה-S&P 500 ב-3 עד 12 החודשים האחרונים.",
  },
  sectorLeader: {
    title: "Sector Leader - מוביל הסקטור",
    text: "המניה עם ה-RS הגבוה ביותר בתוך הסקטור המוביל. אם Energy הסקטור הכי חזק, זו המניה הכי חזקה באנרגיה. שים לב — מוצג רק מתוך 19 המניות שלנו, לא כל השוק.",
  },
  marketBreadth: {
  ...
  breadthCheck: {
    ...
    text: "בודק אם לפחות 5 מניות מתוך 19 עומדות בכל תנאי Stage 2. אם פחות מ-5 — השוק צר מדי, אין מספיק בחירה, ואתה עלול להיתפס במניות גרועות.",
  },

  // ── Potential Breakouts ──
  breakouts: {
    title: "Potential Breakouts - מניות על סף פריצה",
    text: "מציג מניות שעומדות בכל 3 התנאים:\n1. Stage 2 (מגמה עולה)\n2. RS מעל 80 (חזקות מאוד)\n3. פחות מ-2% מתחת ל-Pivot (נקודת הקנייה)\n\nאלו המניות שהכי קרובות לסיגנל קנייה. מוצגות 3 הקרובות ביותר.",
  },
  breakoutStatus: {
    title: "Breakout / Imminent",
    text: "BREAKOUT = המחיר כבר שבר את ה-Pivot (שיא 20 יום). אם הווליום גבוה — זה סיגנל קנייה.\n\nIMMINENT = פחות מ-0.5% מה-Pivot. שים פקודת limit במחיר ה-Pivot ב-Meitav Trade.",
  },
